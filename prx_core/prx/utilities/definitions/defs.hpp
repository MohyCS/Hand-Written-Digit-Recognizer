...
enum KEYS
{
    ...
    PRX_KEY_HOME                = 0xFF50,
    PRX_KEY_PLUS                = 0x43,
    PRX_KEY_LOWER_COMMA         = 0x2c,
    PRX_KEY_LOWER_DOT           = 0x2e,
    PRX_KEY_LOWER_I             = 0x69,
    PRX_KEY_LOWER_P             = 0x70,
    PRX_KEY_LOWER_R             = 0x72,
    PRX_KEY_LOWER_M             = 0x6d,
    PRX_KEY_LOWER_J             = 0x6A,
    PRX_KEY_LOWER_K             = 0x6B,
    PRX_KEY_LOWER_L             = 0x6C,
    PRX_KEY_LOWER_U             = 0x75,
    PRX_KEY_LOWER_O             = 0x6f,
...
namespace prx
{
    namespace util
    {
        ...
        /** @brief Determines which mode (in planning astar search) the astar is running in **/
        enum search_mode_t { STANDARD_SEARCH, LAZY_SEARCH };
    }
}
...
namespace prx
{
    namespace util
    {
        ...
        inline bool fpeq(double A, double B, double maxAbsoluteError = 0.0001, double maxRelativeError = 0.0000001) {
        ...
        inline bool fpge(double A, double B, double maxAbsoluteError = 0.0001, double maxRelativeError = 0.0000001) {
            return A>B || fpeq(A, B, maxAbsoluteError, maxRelativeError);
        }

        inline bool fple(double A, double B, double maxAbsoluteError = 0.0001, double maxRelativeError = 0.0000001) {
             return A<B || fpeq(A, B, maxAbsoluteError, maxRelativeError);
        }
    }
}
...
//=============================================================================
//---------------------------------------------------------
// Are we in Debug or Release mode
//---------------------------------------------------------
...
{\
    ...
    ( std::cout <<"\r"<< PRX_COLOR____ <<"[PRINT][" << NODE_NAME____ << "][" << FILE_NAME____ << "::" << __FUNCTION__ << "][" << __LINE__ << "]:    " << stream );\
    std::cout.flush();\
}
