    ...
    namespace util
    {
        ...
        class goal_t
        {
          ...
          public:
            ...
            virtual unsigned get_last_satisfied_state(space_point_t* output_satisfied_state) const;
            ...
            friend std::ostream& operator<<(std::ostream& os, const goal_t& goal);
          ...
          protected:
            ...
            unsigned last_satisfied_index;
            space_point_t* last_satisfied_state;
          ...
          private:
            ...
            /**
             * @brief Flag to determine whether the goal owns the distance metric and can delete it in the destructor.
             */
            bool metric_from_input;
        };
