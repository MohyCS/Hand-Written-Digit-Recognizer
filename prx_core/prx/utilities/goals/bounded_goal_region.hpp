...
namespace prx
{
    namespace util
    {
         ...
         */
        class bounded_goal_region_t : public goal_state_t
        {

          public:
            bounded_goal_region_t();

            bounded_goal_region_t(const space_t* inspace, distance_metric_t* inmetric, const space_point_t* goal_state, const std::vector<double>& min, const std::vector<double>& max);

            bounded_goal_region_t(const space_t* inspace, distance_metric_t* inmetric, const space_point_t* goal_state, const std::vector<bounds_t*>& new_bounds);
