    ...
    namespace util
    {
        ...
        class goal_state_t : public goal_t
        {
          ...
          public:            
            ...
            goal_state_t(const space_t* inspace, distance_metric_t* inmetric);

            goal_state_t(const space_t* inspace, distance_metric_t* inmetric, const space_point_t* goal_state);

            goal_state_t(const space_t* inspace, distance_metric_t* inmetric, const std::vector<double>& goal_state);
