...
namespace prx
{
    namespace util
    {
        ...
        visualization_msgs::Marker communication_t::send_marker(const geometry_info_t& info)
        {
            ...
            //         marker.color.a = info.color[3];
            //         marker.color.r = info.color[0];
            //         marker.color.g = info.color[1];
            //         marker.color.b = info.color[2];
            //         break;
            //     case 2:
            ...
            //         marker.scale.x = .1;
            //         // if(info.color.get_dim()==3)
            //         //     marker.color.a = 1;
            //         // else
            //         //     marker.color.r = info.color[3];
            //         // marker.color.r = info.color[0];
            //         // marker.color.g = info.color[1];
            //         // marker.color.b = info.color[2];
            //         marker.color.a = 1;
            ...
            //         marker.mesh_resource = "package://pracsys_models/";
...
//            PRX_DEBUG_COLOR("Sending geometries", PRX_TEXT_LIGHTGRAY);
        ...
        bool communication_t::send_plants(const std::string& source_node, const std::vector<std::string>& plant_paths, const std::vector<std::string>& template_paths, double duration, const std::string& destination_node)
        {
            ...
            foreach(const std::string& path, plant_paths)
                  srv.request.paths.push_back(path);

            foreach(const std::string& path, template_paths)
