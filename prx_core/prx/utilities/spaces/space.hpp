...
#include "prx/utilities/math/bounds.hpp"
    ...
    namespace util
    {
        ...
        class space_t
        {
          ...
          public:
            ...
            /**
             * @brief Named Constructor that builds a space given the Topology
             * @param name The string which represents the topolyg to create.
             * @param addresses The memory locations to use for storage of space values.
             */
            static space_t* space_from_topology(const std::string& name, const std::string& topo, const std::vector<double*>& addresses);
            ...
            /**
             * @brief Scales the bounds (lower and upper) by the scaling factor
             */
            virtual void scale_bounds(double scaling_factor);
          ...
          protected:
            ...
            mutable std::pair<unsigned,unsigned> printable;
        };
