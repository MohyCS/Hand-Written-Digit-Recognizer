...
#include "prx/utilities/spaces/mapping_function.hpp"
...
{ 
    namespace util 
    {
        ...
        pluginlib::ClassLoader<mapping_function_t> mapping_function_t::loader("prx_core", "prx::util::mapping_function_t");
