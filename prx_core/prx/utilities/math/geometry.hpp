...
namespace prx
{
    namespace util
    {
        ...
        private:
            ...
            mutable double bounding_radius;
            mutable bool radius_computed;
        ...
        public:
            ...
            /**
             * Specifically creates an ellipsoid with radii a,b,c \c radius
             *
             * @brief Creates an ellipsoid
             * @param radius The radii of the ellipsoid
             */
            void set_ellipsoid(double a, double b, double c);
             ...
             * @param height The height of the cylinder
             */
            void set_bullet_cylinder(double radius, double height);
            ...
            /**
             * Gets the radii of the ellipsoid by reference
             *
             * @brief Gets the radii of the ellipsoid
             */
            void get_ellipsoid(double& a, double& b, double& c) const;
            ...
            double intersect_and_compute_area(geometry_t* other_geom, const config_t& other_global_config, const config_t& this_global_config);
        };
