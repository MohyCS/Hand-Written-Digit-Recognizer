...
#include "prx/utilities/math/vector.hpp"
...
namespace prx
{
    namespace util
    {
        ...
        typedef struct trimesh_face
        {
            ...
            int get_index3() const
            {
                return index3;
            }

            void set_indices(int ind1, int ind2, int ind3)
            {
                index1 = ind1;
                index2 = ind2;
                index3 = ind3;
        ...
        public:
            ...
            /**
             * Computes the normal vector and surface area for a specified face
             *
             * @brief Computes the normal vector for a specified face index. Returns surface area of face
             * @param index The index of the face to compute the normal for
             * @param normal_vector The normal vector of the specified face
             * @param centroid The centroid of the face
             * @return The surface area of face
             */
            double get_normal_vector_for_face(int index, vector_t& normal_vector, vector_t& centroid) const;

            /**
             * Computes the normal vectors and surface areas for all faces
             *
             * @brief Computes the normal vectors and surface areas for all faces
             * @return The normal vectors for all faces 
             */
            void get_all_normal_vectors(std::vector<vector_t>& normal_vectors, std::vector<vector_t>& centroids, std::vector<double>& surface_areas, unsigned max_size = 0) const;

            void get_all_global_normal_vectors(std::vector<vector_t>& normal_vectors, std::vector<vector_t>& centroids, std::vector<double>& surface_areas, const config_t& global_config, unsigned max_size = 0) const;
            ...
            /**
             * Creates a ellipsoid trimesh with the specified radius set.
             *
             * @brief Creates a ellipsoid trimesh with the specified radius set.
             * @param a,b,c The radii of the ellipsoid to be created.
             */
            void create_ellipsoid_trimesh( double a, double b, double c );
             ...
             * @param height The height of the cylinder.
             */
            void create_bullet_cylinder_trimesh( double radius, double height );
