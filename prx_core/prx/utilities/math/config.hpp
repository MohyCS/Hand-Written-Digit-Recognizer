    ...
    namespace util
    {
        ...
        class config_t
        {
          ...
          public:
            ...
            config_t(const std::vector<double>& input_vals);
            config_t(double x, double y, double z, double qx, double qy, double qz, double qw);
            config_t(space_point_t* config_state);
            config_t(const space_point_t* config_state);
             ...
             */
            bool is_approximate_equal(const config_t& conf, double tol = PRX_ZERO_CHECK) const;
            ...
            double distance(const config_t& conf) const;
            double slerp_distance(const config_t& conf) const;
            ...
            void get_orientation(double& qx, double& qy, double& qz, double& qw) const;

            /**
             * Get the se3 state point that represents this configuration
             *
             * @brief Retrieves an se3 state point
             * @param se3 : the parent se3 space
             * @param config_state : the point to be populated
             */
            void get_state_point(const space_t* se3, space_point_t* config_state) const;
            ...
            /**
             * Sets the position and orientation to the input vector information, assuming
             * point order is (x, y, z, wx, wy, wz, wq).
             */
            void set( const std::vector< double >& vec );

            void set(const space_point_t* config_state);
            ...
            void zero_out_position(double eps = 1e-6);
