...
namespace prx
{
    namespace util
    {
        ...
        public:
            ...
            /**
             * Retrieve the yaw represented by this quaternion
             */
             ...
             */
            bool is_approximate_equal( const quaternion_t& other, double tol = PRX_ZERO_CHECK ) const;
            ...
            double slerp_distance( const quaternion_t& other ) const;
