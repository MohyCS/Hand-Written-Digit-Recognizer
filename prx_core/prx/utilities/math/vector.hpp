...
{ 
    namespace util 
    {
        ...
        public:
            ...
            vector_t(const std::vector<double>& input_vector);
            ~vector_t();
            ...
            vector_t& operator=(const std::vector<double> & input_vec);
             ...
             */
            bool is_approximate_equal(const vector_t& other, double tol = PRX_ZERO_CHECK) const;
