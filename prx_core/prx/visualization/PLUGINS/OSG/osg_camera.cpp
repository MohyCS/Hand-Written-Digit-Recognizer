...
//            PRX_PRINT("Attitude: " << pat_node->getAttitude().x() << ","<< pat_node->getAttitude().y() << ","<< pat_node->getAttitude().z() << ","<< pat_node->getAttitude().w() << ",", PRX_TEXT_CYAN);
            ...
            node_position.set( _inverseMatrix(3,0)+0.3, _inverseMatrix(3,1), _inverseMatrix(3,2 ));
            osg::Matrix R(_inverseMatrix);
            R(3,0) = R(3,1) = R(3,2) = 0.0;
            new_eye = osg::Vec3(0.3,0,0) * R; // camera up is +Z, regardless of CoordinateFrame
...
//        up.print();
    ...
    else 
    {
       ...
       // PRX_PRINT("EYE " << eye, PRX_TEXT_CYAN);
       // PRX_PRINT("center " << center, PRX_TEXT_CYAN);
       // PRX_PRINT("up " << up, PRX_TEXT_CYAN);
...
void osg_camera_t::activate_follow()
{
    follower = true;
