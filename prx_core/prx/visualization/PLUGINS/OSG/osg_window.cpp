...
{
    //PRX_WARN_S ("OSG WINDOW FRAME! WITH PICKED GROUP: " << pickedGroup);
...
void osg_window_t::follow_object()
{
    cameras[active_camera].activate_follow();
    osg_viewer->deactivate_bounding_box();
}
