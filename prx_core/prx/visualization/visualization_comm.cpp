...
namespace prx
{
    ...
    {        
        ...
        pluginlib::ClassLoader<visualization_comm_t> visualization_comm_t::loader("prx_core", "prx::vis::visualization_comm_t");
        ...
        visualization_comm_t::visualization_comm_t()
        {
            ...
            decribe_rigid_bodies_service = node.advertiseService<visualization_comm_t,
                    describe_geometries_srv::Request, describe_geometries_srv::Response >
                    ("prx/visualization/rigid_bodies", &visualization_comm_t::rigid_bodies_callback, this);
