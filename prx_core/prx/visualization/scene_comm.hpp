    ...
    namespace vis
    {
        ...
        class scene_comm_t : public util::communication_t
        {
          ...
          protected:
            ...
            /** @brief Service used to add rigid bodies to the scene */
            ros::ServiceServer decribe_rigid_bodies_service;
          ...
          public:
            ...
            /**
             * This service callback processes the request, which contains a map of rigid_ bodies
             ...
             */
            virtual bool rigid_bodies_callback(describe_geometries_srv::Request& request,
             ...
             */
            virtual void text_callback(const prx_core::scene_text_msg& msg);
